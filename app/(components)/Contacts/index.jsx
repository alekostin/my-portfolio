  ...
  return (
    <div className="wrapper">
      <div className="max-w-5xl mx-auto flex flex-col gap-4 items-center justify-center">
        ...
        <a href="mailto:ostinkostin22@gmail.com">
      ...
      <div className="mt-8 flex items-center flex-wrap   gap-8 justify-center">
        <SocialLink title="Github" link="https://github.com/alekostin" />
        <SocialLink
          title="Linkedin"
          link="https://www.linkedin.com/in/oleksandr-kostin/"
        />
        <SocialLink
          title="Facebook"
          link="https://www.facebook.com/alekostin/"
        />
        <SocialLink title="Nextjs" link="https://vercel.com/alekostin" />
      </div>
    </div>
  );
}
