  ...
  return (
    <div className="wrapper">
      ...
      <div className="text-lg tracking-wide flex flex-col gap-6">
        <p>
          Hello, I'm Oleksandr, a dedicated web developer on a journey through
          ...
          boundaries of web development. With Next.js, I've been able to create
          blazing-fast, server-rendered web applications that offer a superior
          user experience. I believe that a great website is not just a digital
          presence but a powerful tool that can help individuals and businesses
          achieve their goals. I'm dedicated to finding innovative solutions,
          staying up-to-date with the latest technologies, and ensuring that
          every project I take on is a unique and memorable digital experience.
        </p>
        <p>
          In addition to my love for coding, my heart beats to the rhythm of
          music. I've spent two decades as a percussionist, exploring the world
          of beats, rhythms, and melodies. Notably, I had the unique opportunity
          to spend three years at sea, performing in the orchestra aboard cruise
          liners, where I brought musical magic to travelers from all corners of
          the globe.
        </p>
